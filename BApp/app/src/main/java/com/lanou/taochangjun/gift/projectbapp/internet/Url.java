...
public class Url {
    ...
    // 游戏杂谈
    public static final String GAMETALK = "14847213448701 ";
    public static final String GAMETALKUNDER = "&zoneId=14847213448701&pageSize=16";

    // 搞笑
    public static final String FUNNY = "14679608401831";
    public static final String FUNNYUNDER = "&zoneId=14679608401831&pageSize=16";

    // 动画
    public static final String ANIMATION = "14679608401821";
    public static final String ANIMATIONUNDER = "&zoneId=14679608401821&pageSize=16";

    // 萌宠
    public static final String ANIMAL = "14679608401781";
    public static final String ANIMALUNDER = "&zoneId=14679608401781&pageSize=16";

    // 美食
    public static final String FOOD = "14679608401801";
    public static final String FOODUNDER = "&zoneId=14679608401801&pageSize=16";

    // 二次元
    public static final String EMELENT = "14679608401851";
    public static final String EMELENTUNDER = "&zoneId=14679608401851&pageSize=16";

    // 八卦头条
    public static final String HEADLINES = "14679608401791";
    public static final String HEADLINESUNDER = "&zoneId=14679608401791&pageSize=16";

    // 网剧
    public static final String TV = "14679608401841";
    public static final String TVUNDER = "&zoneId=14679608401841&pageSize=16";

    // LOL
    public static final String LOL = "14836951235121";
    public static final String LOLUNDER = "&zoneId=14836951235121&pageSize=16";

    // 炉石传说
    public static final String STONE = "14836951235151";
    public static final String STONEUNDER = "&zoneId=14836951235151&pageSize=16";

    // 守望先锋
    public static final String VANGUARD = "14836951235161";
    public static final String VANGUARDUNDER = "&zoneId=14836951235161&pageSize=16";
